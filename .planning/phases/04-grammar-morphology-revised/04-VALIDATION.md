...
| 04-04-T1 | 04-04 | 4 | GRAM-06 | — | Router branch replacement is atomic; no /morphology routes remain | widget | `flutter test --no-pub test/widget/grammar/grammar_router_test.dart` | will-be-created | ⬜ pending |
| 04-04-T2 | 04-04 | 4 | GRAM-01 | — | Template picker modal behavior; POS+Dimensions CRUD | widget | `flutter test --no-pub test/widget/grammar/pos_dimensions_page_test.dart` | will-be-created | ⬜ pending |
| 04-04-T3 | 04-04 | 4 | GRAM-02, GRAM-06 | T-04-17 | Kind-aware RuleEditorDialog; live tiebreak banner; unbound rule validation error | widget | `flutter test --no-pub test/widget/grammar/rule_editor_dialog_kind_test.dart` | will-be-created | ⬜ pending |
| 04-04-T4 | 04-04 | 4 | GRAM-03, GRAM-05 | T-04-15, T-04-16, T-04-18 | Cell override DAO (lexemeId, featureSet) upsert; coverage provider | unit + widget | `dart run build_runner build --delete-conflicting-outputs && flutter test --no-pub test/unit/grammar/paradigm_cell_override_test.dart test/widget/grammar/paradigm_table_widget_test.dart` | will-be-created | ⬜ pending |
| 04-04-T5 | 04-04 | 4 | GRAM-04 | T-04-11 | Typology form auto-save + all three fields written correctly | widget | `flutter test --no-pub test/widget/grammar/typology_page_test.dart` | will-be-created | ⬜ pending |
| 04-05-T1 | 04-05 | 5 | GRAM-06, GRAM-07 | T-04-22 | Lexicon Derivations sub-tab routes + rules_page filter | widget | `flutter test --no-pub test/widget/grammar/lexicon_derivations_tab_test.dart` | will-be-created | ⬜ pending |
| 04-05-T2 | 04-05 | 5 | GRAM-06, GRAM-07 | T-04-19 | computedDerivedFormsProvider filters by kind='derivational' (pitfall #9) | unit | `flutter test --no-pub test/unit/lexicon/computed_derived_forms_kind_filter_test.dart` | will-be-created | ⬜ pending |
| 04-05-T3 | 04-05 | 5 | GRAM-03 | T-04-20, T-04-21 | Word detail paradigm embed is read-only and scoped per-lexeme | widget | `flutter test --no-pub test/widget/grammar/word_detail_paradigm_test.dart` | will-be-created | ⬜ pending |
...
- [ ] `test/widget/grammar/rule_editor_dialog_kind_test.dart` — created by 04-04-T3 (GRAM-02, GRAM-06)
- [ ] `test/unit/grammar/paradigm_cell_override_test.dart` — created by 04-04-T4 (GRAM-05)
- [ ] `test/widget/grammar/paradigm_table_widget_test.dart` — created by 04-04-T4 (GRAM-03, GRAM-05)
- [ ] `test/widget/grammar/typology_page_test.dart` — created by 04-04-T5 (GRAM-04)
- [ ] `test/widget/grammar/lexicon_derivations_tab_test.dart` — created by 04-05-T1 (GRAM-06, GRAM-07)
- [ ] `test/unit/lexicon/computed_derived_forms_kind_filter_test.dart` — created by 04-05-T2 (GRAM-06, GRAM-07)
- [ ] `test/widget/grammar/word_detail_paradigm_test.dart` — created by 04-05-T3 (GRAM-03)
...
| Tiebreaker banner copy clarity under real conflict scenarios | GRAM-02 | UX judgement — the text is locked, but its placement and visibility need manual review | Create two rules with identical bindings. Open the second rule in the editor. Verify the red banner is instantly visible, legible, and mentions the other rule by name. |
| Migration banner dismissibility and copy | GRAM-06 | UX judgement | Open v7 project → migrate → open /grammar/inflectional. Verify banner appears, copy matches UI-SPEC, dismiss button works, banner stays dismissed after restart. |
